...
6. `./ai_pedagogy.md` — Three-Mode AI Learning Framework (Solo, AI-Partnered, Reflection)
7. `./skill_log.md` — teaching craft journal (what worked, what flopped)
8. `./contingency.md` — backup activities, pivot plans
9. Task-specific files as needed: `class_logs/`, `quiz_bank.md`, `exam_bank.md`, `class_prep_reference.md`, `archive_completed_actions.md`
...
| Field | Value |
|---|---|
| Course | MGMT 162: Strategic Analysis — The Business Capstone |
| Quarter | Spring 2026 |
| University | Santa Clara University |
| Instructor | Vyas Sreenivas |
| Section 2 | Tue/Thu, 2:00-3:40 PM (~30 students) |
| Section 3 | Tue/Thu, 5:40-7:20 PM (~20 students) |
...
│   ├── ai_pedagogy.md               [Three-Mode AI Learning Framework]
...
2. **AI Mode** — Check the session's AI Mode (Solo / AI-Partnered / Reflection). Design activities that honor the mode. See `ai_pedagogy.md` for the full framework and Mollick's 7 AI roles.
3. **Energy** — What's the energy arc? (hook → build → peak → reflect)
4. **Activities** — What activities serve the intent, fit the energy, and respect the AI mode?
5. **Timed plan** — Map activities to the 100-minute template.
